package me.pigauts.voxelmenus.event;
...
public class MenuClickEvent extends CancellableEvent {

    private static final HandlerList HANDLERS = new HandlerList();

    private final MenuPlayer player;
    private final OpenMenu openMenu;
    private final InventoryClickEvent event;

    public MenuClickEvent(MenuPlayer player, OpenMenu openMenu, InventoryClickEvent event) {
        this.player = player;
