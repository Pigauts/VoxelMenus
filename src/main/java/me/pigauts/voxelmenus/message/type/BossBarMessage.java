...
public class BossBarMessage implements Message {
	...
	public static BossBarMessage fromConfig(Config config) {
		...
		return new BossBarMessage(
				...
				config.getNotNull(config::getBarStyle, "style"),
				config.getNotNull(config::getBarColor, "color"),
				config.getNotNull(config::getInt, "duration"),
				config.getNotNull(config::getInt, "frequency"),
